...
function newVariant(baseVariant, options) {
  return { ...baseVariant, async importModuleLoader() {
    ...
    return async function() {
      let moduleLoaderArg = options.emscriptenModule ? { ...options.emscriptenModule } : {}, log = options.log ?? ((...args) => debugLog("newVariant moduleLoader:", ...args)), tapValue = /* @__PURE__ */ __name((message, val) => (log(...message, val), val), "tapValue"), force = /* @__PURE__ */ __name((val) => typeof val == "function" ? val() : val, "force");
